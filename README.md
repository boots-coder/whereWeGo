...
​    •    **MyPlayground.playground** 和 **homeworkweek3.playground**：用于测试和实验的 Playground 文件。

​    •    **.DS_Store**：macOS 系统文件，存储文件夹的显示属性。

​    •    **ApplePay.png**、**MapKit.png**、**exploreactivity.png**、**explorecart.png**、**exploreherecart.png**、**exploreheredetailview.png**、**exploreheretripview.png**、**explorescreen.png**：应用界面的截图或相关图片资源。
